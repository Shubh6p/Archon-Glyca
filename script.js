...
function updateNavbarAuth() {
    ...
    if (userId) {
        authSection.innerHTML = `
            <a href="profile.html" class="group relative px-8 py-3 border border-accent/30 rounded-full transition-all hover:border-accent overflow-hidden">
        ...
        authSection.innerHTML = `
            <a href="login.html" class="px-8 py-3 border border-accent/30 rounded-full hover:bg-accent hover:text-black transition-all text-[10px] font-bold uppercase tracking-widest">
                Login
            </a>
        `;
    }
